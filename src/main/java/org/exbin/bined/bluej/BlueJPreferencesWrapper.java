...
public class BlueJPreferencesWrapper implements Preferences {

    private final BlueJ bluej;

    public BlueJPreferencesWrapper(BlueJ bluej) {
        this.bluej = bluej;
    }
    ...
    public Optional<String> get(String key) {
        return Optional.ofNullable(bluej.getExtensionPropertyString(key, null));
    }
